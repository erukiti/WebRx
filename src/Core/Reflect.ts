...
module Reflect {
    ...
    const __Metadata__ = wx.createWeakMap<Object, wx.IMap<string | symbol, wx.IMap<any, any>>>();
    ...
    function GetOrCreateMetadataMap(target: Object, targetKey: string | symbol, create: boolean): wx.IMap<any, any> {
        ...
        if (!targetMetadata) {
            ...
            targetMetadata = wx.createMap<string | symbol, wx.IMap<any, any>>();
        ...
        if (!keyMetadata) {
            ...
            keyMetadata = wx.createMap<any, any>();
