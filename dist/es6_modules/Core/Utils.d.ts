...
export declare function whenAny<TRet, T1>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, selector: (T1) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, selector: (T1, T2, T3, T4, T5) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2, T3>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, arg3: wx.IObservableProperty<T3> | Rx.IObservable<T3>, selector: (T1, T2, T3, T4, T5) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2, T3, T4>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, arg3: wx.IObservableProperty<T3> | Rx.IObservable<T3>, arg4: wx.IObservableProperty<T4> | Rx.IObservable<T4>, selector: (T1, T2, T3, T4, T5) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2, T3, T4, T5>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, arg3: wx.IObservableProperty<T3> | Rx.IObservable<T3>, arg4: wx.IObservableProperty<T4> | Rx.IObservable<T4>, arg5: wx.IObservableProperty<T5> | Rx.IObservable<T5>, selector: (T1, T2, T3, T4, T5) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2, T3, T4, T5, T6>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, arg3: wx.IObservableProperty<T3> | Rx.IObservable<T3>, arg4: wx.IObservableProperty<T4> | Rx.IObservable<T4>, arg5: wx.IObservableProperty<T5> | Rx.IObservable<T5>, arg6: wx.IObservableProperty<T6> | Rx.IObservable<T6>, selector: (T1, T2, T3, T4, T5, T6) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2, T3, T4, T5, T6, T7>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, arg3: wx.IObservableProperty<T3> | Rx.IObservable<T3>, arg4: wx.IObservableProperty<T4> | Rx.IObservable<T4>, arg5: wx.IObservableProperty<T5> | Rx.IObservable<T5>, arg6: wx.IObservableProperty<T6> | Rx.IObservable<T6>, arg7: wx.IObservableProperty<T7> | Rx.IObservable<T7>, selector: (T1, T2, T3, T4, T5, T6, T7) => TRet): Rx.Observable<TRet>;
export declare function whenAny<TRet, T1, T2, T3, T4, T5, T6, T7, T8>(arg1: wx.IObservableProperty<T1> | Rx.IObservable<T1>, arg2: wx.IObservableProperty<T2> | Rx.IObservable<T2>, arg3: wx.IObservableProperty<T3> | Rx.IObservable<T3>, arg4: wx.IObservableProperty<T4> | Rx.IObservable<T4>, arg5: wx.IObservableProperty<T5> | Rx.IObservable<T5>, arg6: wx.IObservableProperty<T6> | Rx.IObservable<T6>, arg7: wx.IObservableProperty<T7> | Rx.IObservable<T7>, arg8: wx.IObservableProperty<T8> | Rx.IObservable<T8>, selector: (T1, T2, T3, T4, T5, T6, T7, T8) => TRet): Rx.Observable<TRet>;
/**
